...
const Footer: FC<FooterProps> = ({}) => {
  ...
  return (
    <>
      <div className="pt-12 lg:hidden bg-slate-800">
        <div className="flex items-center mx-4 justify-evenly">
          <Input
            className="rounded-full w-[70%]"
            placeholder="  Updates in your inbox…"
          />
          <button className="w-20 h-10 font-medium text-white transition-all duration-100 ease-linear delay-100 rounded-full shadow-xl bg-[#f44336] hover:bg-opacity-80 hover:text-white focus:outline-none focus:ring-1">
            Go
          </button>
        </div>
        <div className="flex justify-between py-8 mx-12 mt-9">
          <div>
            {home.map((i) => (
              <Link
                className="flex flex-col py-3 font-medium tracking-wider text-white"
                href=""
                key={i.text}>
                {i.text}
              </Link>
        ...
        <div className="flex items-center px-8 ">
          <Image
            className="w-16 px-4 md:mx-8 md:w-20"
            src={instagram}
            alt="logo"
          />
          <Image
        ...
        <p className="max-w-md pt-10 leading-relaxed text-center text-gray-500 ">
          Copyright 2020. All Rights Reserved
        </p>
      </div>

      <div className="hidden bg-slate-800 lg:flex lg:items-start">
        <div className="py-3 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="146"
            height="24"
            className="mx-24 mt-12">
            <g fill="none" fillRule="evenodd">
              <path
                fill="#fff"
                fillRule="nonzero"
          ...
          <div className="flex items-center px-8 py-12 mx-12">
            <Image className="w-16 px-4 pt-4 " src={instagram} alt="logo" />
            <Image className="w-16 px-4 pt-4 " src={youtube} alt="logo" />
            <Image className="w-16 px-4 pt-4 " src={pinterest} alt="logo" />
            <Image className="w-16 px-4 pt-4 " src={facebook} alt="logo" />
            <Image className="w-16 px-4 pt-4 " src={twitter} alt="logo" />
          </div>
        </div>
        <div className="flex py-6">
          <div className="mx-12">
            {home.map((i) => (
              <Link
                className="flex flex-col pt-5 font-medium tracking-wider text-white"
                href=""
                key={i.text}>
                {i.text}
              </Link>
        ...
        <div className="flex flex-col items-center py-12 mx-4 justify-evenly">
          ...
          <p className="max-w-md pt-10 leading-relaxed text-left text-gray-500 ">
            Copyright 2020. All Rights Reserved
          </p>
        </div>
      </div>
